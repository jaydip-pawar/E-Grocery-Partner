...
class _MenuWidgetState extends State<MenuWidget> {
  ...
  Future<DocumentSnapshot> getVendorData() async {
    var result = await FirebaseFirestore.instance.collection("shop_owner").doc(user.uid).get();
    setState(() {
      vendorData = result;
    });
    return result;
  ...
  Widget build(BuildContext context) {
    ...
    _provider.getShopName(vendorData != null ? vendorData.data()["shop_name"] : '');
    return Container(
      color: Colors.white,
              ...
              child: Row(
                children: [
                  CircleAvatar(
                    ...
                    child: CircleAvatar(
                      radius: 30,
                      backgroundImage: vendorData != null ? NetworkImage(vendorData.data()['profile_pic']) : null,
                    ),
                  ),
                  SizedBox(
                    width: 10,
                  ...
                  Text(
                    vendorData != null ? vendorData.data()['shop_name'] : "Shop Name",
                    style: TextStyle(
                      color: Colors.black,
